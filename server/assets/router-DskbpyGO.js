...
const appCss = "/assets/styles-B7PF8wsH.css";
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Web app displays project data from Excel in interactive cards with like functionality." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Web app displays project data from Excel in interactive cards with like functionality." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Web app displays project data from Excel in interactive cards with like functionality." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1c9dc74f-2983-416b-aa5d-1ea02b79838a/id-preview-ff0f4f05--54c204e7-98d4-4619-81ea-319326981d22.lovable.app-1778480572769.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1c9dc74f-2983-416b-aa5d-1ea02b79838a/id-preview-ff0f4f05--54c204e7-98d4-4619-81ea-319326981d22.lovable.app-1778480572769.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter$1 = () => import("./projects-Di7Hlseu.js");
const Route$1 = createFileRoute("/projects")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore student projects built with prompt-driven web design. Browse, preview, and like your favorites."
    }]
  })
});
const $$splitComponentImporter = () => import("./index-BdMIhp9I.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "PIEERU is a research unit at Bangladesh Army University of Science and Technology (BAUST), Saidpur, Nilphamari, advancing professional ethics for the technological era."
    }, {
      property: "og:title",
      content: "PIEERU — Research Unit at BAUST"
    }, {
      property: "og:description",
      content: "Advancing professional ethics in the age of AI, automation, and data — from BAUST, Saidpur, Nilphamari, Bangladesh."
    }]
  })
});
const ProjectsRoute = Route$1.update({
  id: "/projects",
  path: "/projects",
